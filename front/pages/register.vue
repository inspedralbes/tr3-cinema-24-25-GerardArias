<template>
  <div class="register-container">
    <form class="form" @submit.prevent="handleRegister">
      <div class="title">Registrar Usuari</div>

      <div>
        <label for="name" class="label">Nom:</label>
        <br />
        <input v-model="form.name" class="input" type="text" id="name" required placeholder="Nom" />
      </div>

      <div>
        <label for="lastname" class="label">Cognom:</label>
        <br />
        <input v-model="form.lastname" class="input" type="text" id="lastname" required placeholder="Cognom" />
      </div>
      ...
      <div>
        <label for="phone" class="label">Telèfon:</label>
        <br />
        <input v-model="form.phone" class="input" type="text" id="phone" required placeholder="Telèfon" />
      </div>

      <button type="submit" class="button-confirm">Registrar</button>
    </form>
    <div class="image-container">
      <img src="../assets/img/cine.jpg" alt="Cine Image" class="image" />
    </div>
  </div>
</template>
